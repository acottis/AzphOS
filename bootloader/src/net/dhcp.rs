...
//! 
const DHCP_OPTIONS_LEN: usize = 156; // Max allowed size
...
const OPTIONS: [u8; DHCP_OPTIONS_LEN] = [
    ...
    ,0x11,0x1a,0x2b,0x3c,0x42,0x43,0x77,0x80,
    
    // Random params
    // 0x81,0x82,0x83,0x84,0x85,0x86,0x87,0xaf,0xcb,
    0,0,0,0,0,0,0,0,0,

    // Etherboot
    // 0xaf,0x2d,0xb1,0x05,0x01,0x80,0x86,0x10,0x0e,0xeb,0x03,0x01,0x14,0x01,0x17,
